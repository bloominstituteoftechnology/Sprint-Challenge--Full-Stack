...
import { putBudget } from '../actions';

class BudgetFormEdit extends Component {
...
export default connect(mapStateToProps, { putBudget })(BudgetFormEdit);